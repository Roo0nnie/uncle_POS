<div class="mt-4">
    <h5 class="card-title mt-5 mb-3">Vegetables Products</h5>
</div>
...
<div class="row mb-4">
        <div class="col-md-6">
            <div class="input-group">
                ...
                <input type="text" id="searchInputVegetables" class="form-control" placeholder="Search by name...">
            </div>
        </div>
    </div>
...
<div id="order-container">
                      <div class="row">
                      <?php
                        $sql = "SELECT * FROM product WHERE prod_category = 18";
