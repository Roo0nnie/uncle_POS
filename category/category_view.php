...
if (isset($_SESSION['id']) && isset($_SESSION['name'])) {
  if(isset($_GET['id'])){
    ...
    if ($result_category && mysqli_num_rows($result_category) > 0) {
        ...
        $view_id = $row_category['id'];
        $view_name = $row_category['name'];
        $view_description = $row_category['description'];
        $view_created = $row_category['created_at'];
        $view_updated = $row_category['updated_at'];
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
              <div>
                <h3 class="fw-bold mb-3">View Category</h3>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12">
                      ...
                      <div class="col-sm-12 col-md-12 ms-3 ms-sm-0">
                        <div class="numbers">
                            <div class="mt-4">
                                ...
                                <textarea name="" id="" readonly class="form-control"><?php print $view_description ?></textarea>
                            </div>
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-12 ms-3 ms-sm-0">
                        <div class="row">
                          ...
                          <div class="numbers">
                            <div class="mt-4">
                                <h4 class="card-title">Updated Category</h4>
                ...
                <div class="ms-md-auto py-2 py-md-0">
                    <a href="../category.php" class="btn btn-primary "><i class="fas fa-cart-plus"></i> Back Category</a>
                  </div>
              </div>
            </div>
          </div>
