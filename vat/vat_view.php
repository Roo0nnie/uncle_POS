...
if (isset($_SESSION['id']) && isset($_SESSION['name'])) {
  if(isset($_GET['id'])){
    ...
    if ($result_vat && mysqli_num_rows($result_vat) > 0) {
        ...
        $view_id = $row_vat['id'];
        $view_name = $row_vat['name'];
        $view_vat = $row_vat['vat'];
        $view_description = $row_vat['description'];
        $view_created = $row_vat['created_at'];
        $view_updated = $row_vat['updated_at'];
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
              <div>
                <h3 class="fw-bold mb-3">View VAT</h3>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-12 col-md-6 ms-3 ms-sm-0">
                        <div class="numbers">
                            <div class="mt-4">
                                ...
                                <input type="text" readonly class="form-control" value="<?php print $view_vat ?>">
                            </div>
                        </div>
                      </div>
                      </div>
                      ...
                      <div class="col-sm-12 col-md-12 ms-3 ms-sm-0">
                        <div class="row">
                          ...
                          <div class="numbers">
                            <div class="mt-4">
                                <h4 class="card-title">Created VAT</h4>
                          ...
                          <div class="numbers">
                            <div class="mt-4">
                                <h4 class="card-title">Updated VAT</h4>
