        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
              <div>
                <h3 class="fw-bold mb-3">New Order</h3>
                      ...
                      <?php
                        ...
                        if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '
                                <div class="col-lg-3 col-sm-6 col-md-4 mb-3 mt-3">
                    ...
                    <div class="mb-4">
                      <div class="card card-black">
                        <div class="card-body">
                          <h4>Order Summary</h4>
                          <div class="row">
                            <div class="d-flex justify-content-between justify-content-center align-items-center gap-2">
