...
session_start();
  ...
  if(isset($_POST['submit'])) {
    ...
    $prod_trans_id = mysqli_real_escape_string($conn, trim($_POST['trans_id']));
    $prod_date = mysqli_real_escape_string($conn, trim($_POST['del_date']));

    if(!empty($prod_name) && !empty($prod_trans_id) && !empty($prod_date)) {

      $sql = "INSERT INTO delivery (sup_id, trans_id, del_date, created_at) 
      VALUES ('$prod_name', '$prod_trans_id', '$prod_date', NOW())";
     
      if (mysqli_query($conn, $sql)) {
        $_SESSION['error_message'] = "Delivery added successfully.";
        header("Location: ../delivery.php");
        exit();
      } else {
        $_SESSION['error_message'] = "Failed to add delivery.";
                  ...
                  <div class="card card-stats card-round">
                    ...
                    <div class="ms-md-auto py-2 py-md-0">
                      <button type="submit" name="submit" class="btn btn-primary ">
                        <i class="fas fa-cart-plus"></i> Add Delivery
                      </button>
